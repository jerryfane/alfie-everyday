...
,addDays=(t,e)=>{t=new Date(t);return t.setDate(t.getDate()+e),t}

,addStyles=()=>{var t=document.createElement("style");t.textContent=`
        html,
        body {
          margin: 0;
          padding: 0;
    ...
    ,document.head.appendChild(t)},addFonts=()=>{document.head.append(parseHTML(`
<style>
@font-face {
  ...
  src: url(/content/0178e979782dde2ee885a156f2c25f29872b020670e7a39887629dc8c2fbaec1i0) format('woff2');
      ...
      pickTextColor=t=>{t="#"===t.charAt(0)?t.slice(1,7):t,t=[parseInt(t.substring(0,2),16)/255,parseInt(t.substring(2,4),16)/255,parseInt(t.substring(4,6),16)/255].map(t=>t<=.03928?t/12.92:Math.pow((t+.055)/1.055,2.4));return.179<.2126*t[0]+.7152*t[1]+.0722*t[2]?"#000":"#FFF"
